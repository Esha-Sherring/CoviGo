...
class SanitizationRequest extends StatefulWidget {
  @override
  _SanitizationRequestState createState() => _SanitizationRequestState();
}

class _SanitizationRequestState extends State<SanitizationRequest> {
          ...
          child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Image.asset('images/SanitizationRequest.png'),
                ),
              ]
          ),
        ),
